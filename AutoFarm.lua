-- AutoFarm.lua
print("[AutoFarm] module downloaded")

return function(Window)
  print("[AutoFarm] factory called")
  local Tab = Window:AddTab({ Name = "Autofarm", Icon = "zap", Description = "…" })
  local Box = Tab:AddLeftGroupbox("Enemy Autofarm", "swords")
